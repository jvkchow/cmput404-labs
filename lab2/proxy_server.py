...
def send_request(host, port, request):
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as client_socket:
        ...
        # assmble response, be careful here, recall that recv (bytes) blocks until it receives data!
...
def handle_connection(conn, addr):
    with conn:
        ...
        conn.sendall(response) # return the respones from www.google.com back to the client
